const lang = {
  ...
  added: 'added',
  scan_to_assign_barcode: 'Scan barcode label to link this product',
  scan_to_assign_barcode_hint:
    'Stick the printed label on the product, then scan it here and click Save.',
  barcode_assigned_save_product: 'Barcode assigned — click Save to store this product.',
  bulk_barcode_print: 'Barcode Labels',
  bulk_barcode_print_subtitle: 'Print labels in bulk for your shop products',
  bulk_barcode_workflow:
    '1) Generate barcodes → 2) Print labels → 3) Stick on products → 4) Scan when saving each product → 5) Scan on invoice to bill.',
  print_product_labels: 'Print Product Barcode Labels',
  generate_barcode_selected: 'Generate Barcode (Selected)',
  generate_barcode_all_missing: 'Generate All Missing Barcodes',
  print_selected_labels: 'Print Selected Labels',
  print_all_labels: 'Print All Product Labels',
  select_products_first: 'Select products from the table first.',
  generate_barcode_before_print: 'Generate or assign barcodes before printing.',
  no_products_with_barcode: 'No products have barcodes yet.',
  selected_without_barcode: 'selected product(s) still need a barcode.',
  print_blank_label_sheet: 'Print Blank Label Sheet (pre-assign later)',
  blank_label_sheet_hint:
    'Prints new barcode stickers. Stick on products, then scan each one when saving the product in Products.',
  label_count: 'Number of labels',
  print_blank_labels: 'Print Blank Labels',
  blank_barcode_print_hint: 'Stick each label on a product, then scan it when saving that product.',
  blank_barcode_labels: 'Blank Barcode Labels',
  barcode_labels: 'Barcode Labels',
  scan_barcode_invoice_hint: 'Each scan adds the product with price; scan again to increase quantity. Totals update automatically.',
  expenses: 'Expenses',
