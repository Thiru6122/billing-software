const lang = {
  ...
  bulk_barcode_print_subtitle: 'Print barcode stickers first — map them to products later by scanning',
  step_print_labels: 'Step 1 — Print barcode labels',
  step_print_labels_desc: 'Generate and print stickers (not linked to any product yet).',
  ...
  reprint_unassigned: 'Re-print Unassigned Labels',
  ...
  scan_barcode_to_map: 'Scan printed label to map barcode',
  barcode_mapped_hint: 'This barcode will be linked to the product when you click Save.',
  barcode_scan_required_hint: 'Scan a printed label above before saving.',
  ...
  label_details_hint:
    'Set company name, product text, MRP, pack date and expiry — same layout as your customer sample. Values are remembered for next print.',
  ...
  tvs_neo46_print_hint:
    'TVS LP 46 Neo: 110mm (11cm) wide roll, 3 labels per row (~36.7mm × 25mm each), 2mm gap. Print dialog: Custom paper 110 × 27mm, Portrait (not Landscape), Scale 100%, Margins None. Only the rows you select are sent — e.g. 3 labels = one 27mm feed, not a full sheet.',
